...
the occurence of the group no. is the frequency that this amount of time there is
a price of this price group.

Then I created one more function for plotting histogram. In which I used matplotlib's
plt.hist() function to plot histogram.
